const icons = {
  ...
  add: `<path fill-rule="evenodd" d="M8 1a.75.75 0 01.75.75V7h5.25a.75.75 0 010 1.5H8.75v5.25a.75.75 0 01-1.5 0V8.5H2a.75.75 0 010-1.5h5.25V1.75A.75.75 0 018 1z"/>`,
  delete: `<path fill-rule="evenodd" d="M2 7.25a.75.75 0 01.75-.75h10.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75z"/>`,
};
